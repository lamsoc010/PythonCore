...
logoImagePath = "TheSinhVien/assets/image/logo.png"



def renderStudentCard(student, i):
    ...
    # Tạo thư mục mới
    folder_path = f"./TheSinhVien/output/{unidecode(student.khoa).replace(' ', '')}/{unidecode(student.nganh).replace(' ', '')}/{student.lop}"
